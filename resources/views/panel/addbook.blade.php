    ...
    <div class="content-info">
        ...
        <div class="module">
            <div class="module-body">
                <form class="form-horizontal row-fluid" id="addBookFormId" action="{{ route('store-book') }}">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select tabindex="1" id="category" name="category_id" data-placeholder="Select category.."
                                class="span8">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="number" min="0" value="{{ isset($book) ? $book->overdue_price : '0' }}"
                                id="overdue_price" name="overdue_price" class="span8">
                        </div>
                    </div>
